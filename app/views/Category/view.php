                        ...
                        <?php foreach($products as $product): ?>
                            <div class="col-md-4 product-left p-left">
                                <div class="product-main simpleCart_shelfItem">
                                    <a href="<?=PATH?>/product/<?=$product->alias;?>" class="mask"><img class="img-responsive zoom-img" style="width: 125px; height: 200px; object-fit:cover;object-position: 0px 0px;" src="<?=PATH?>/images/<?=$product->img;?>" alt="" /></a>
