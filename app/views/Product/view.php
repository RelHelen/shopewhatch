                ...
                <div class="sngl-top">
                        ...
                        <div class="flexslider">
                            <ul class="slides">
                                ...
                                <li data-thumb="<?=PATH?>/images/<?=$item->img;?>">
                                    <div class="thumb-image"> <img src="<?=PATH?>/images/<?=$item->img;?>" data-imagezoom="true" class="img-responsive" alt=""/> </div>
                                </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <?php else: ?>
                            <img src="<?=PATH?>/images/<?=$product->img;?>" alt="">
                        <?php endif; ?>
                        <!-- FlexSlider -->
                    ...
                    <div class="col-md-7 single-top-right">
                        <div class="single-para simpleCart_shelfItem">
                            ...
                            <a id="productAdd" data-id="<?=$product->id;?>" href="<?=PATH?>/cart/add?id=<?=$product->id;?>" class="add-cart item_add add-to-cart-link">В корзину</a>
                        ...
                        <div class="col-md-4 product-left p-left">
                            <div class="product-main simpleCart_shelfItem">
                                ...
                                <div class="product-bottom">
                                    ...
                                    <!-- <p>Explore Now</p> -->
                                    <h4>
                                        <a class="item_add add-to-cart-link" href="<?=PATH?>/cart/add?id=<?=$item['id'];?>" data-id="<?=$item['id'];?>"><i></i></a>
