...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="<?=PATH;?>" class="logo" target="_blank">
            ...
            <span class="logo-lg"><b>Консоль</b><span class="small"> оTW</span></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?= PATH ?>/adminlte/dist/img/avatat1.jpg" class="user-image" alt="User Image"><?=$_SESSION['user']['name'];?></span>
                        </a>
